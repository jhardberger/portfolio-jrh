			...
			<Fade clear cascade>
				...
				<div className='bio'>
					...
					<div className='bio-copy'>
						<h1>about me</h1>
						<p> I graduated from Northwestern University in 2015 with a deep love of writing and only a few vaguely sketched plans re: my career. Seeking to put my passion to work, I set out on an editorial journey that ended up lasting more than three years. In that time, I grew tremendously as a writer, reporter, and editor. I learned how to engage with readers and sources, both through my writing and on social media.
						</p>
